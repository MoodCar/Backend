...
async function setTest() {
    try{
        ...
        try{
            const setTestQuery = "alter table user auto_increment = 4";
            await connection.query(setTestQuery);
            const setTestUserQuery = "insert ignore into user(email,name,provider,providerId,token) values ('46nklnszc@gmail.com','테스트4','google','785681234','43btvny981y98cn1noihjnroiqw')";
            console.log("-----------------");
